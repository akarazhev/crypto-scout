...
/**
 * Entity representing the Bybit Spot Tickers ETH/USDT data in the crypto_scout schema.
 * This table is configured as a TimescaleDB hypertable for time-series data optimization.
 */
@Entity
@Table(name = "bybit_spot_tickers_eth_usdt", schema = "crypto_scout")
public class BybitSpotTickersEthUsdt {
    @Id
     ...
     */
    public BybitSpotTickersEthUsdt() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        final var that = (BybitSpotTickersEthUsdt) o;
